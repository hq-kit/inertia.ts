    ...
    (
        ...
        return (
            <div
                ref={ref}
                className={cn(
                    'grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-muted/60 bg-background px-2.5 py-1.5 text-xs text-foreground shadow-xl',
                    className,
                )}
            >
                ...
                <div className="grid gap-1.5">
                    {payload.map((item, index) => {
                        ...
                        const itemConfig = resolvePayloadConfig(
                            config,
                            item,
                            key,
                        );

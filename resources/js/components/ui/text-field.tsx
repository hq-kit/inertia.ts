            ...
            <FieldGroup data-loading={isPending ? 'true' : undefined}>
                ...
                {isRevealable ? (
                    <ButtonPrimitive
                        ...
                        className="relative mr-2.5 flex items-center justify-center rounded-lg focus:outline-none focus-visible:ring-1 focus-visible:ring-primary [&>[data-slot=icon]]:text-muted-foreground"
                    >
                        <IconEyeClosed
                            className={cn(

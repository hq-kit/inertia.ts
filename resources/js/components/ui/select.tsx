    ...
    return (
        ...
        >
            ...
            <Group className="relative">
                ...
                >
                    {props.prefix && (
                        <span className="-mr-1">{props.prefix}</span>
                    )}
                    <SelectValue className="flex-1 text-base placeholder-shown:text-muted-foreground lg:text-sm [&_[slot=description]]:hidden" />
